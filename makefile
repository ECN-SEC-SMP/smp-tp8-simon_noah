...
OBJS_BOTH = $(OBJ_DIR)/animal.o $(OBJ_DIR)/attaque.o $(OBJ_DIR)/Lion.o $(OBJ_DIR)/Loup.o $(OBJ_DIR)/Ours.o $(OBJ_DIR)/Pierre.o 


#fichier néssesaire au main
OBJS_MAIN   = $(OBJ_DIR)/main.o  $(OBJS_BOTH)
#fichier néssesaire au test
OBJS_TEST   = $(OBJ_DIR)/testAnimals.o $(OBJ_DIR)/unity.o  $(OBJS_BOTH)
